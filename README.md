...
| ToDo | Description | Progress |
|--|--|--|
| Experimenting with new characters | Experimenting & debugging |	20% |
| Game testing & research |* |	100% |

### Dinu Marius
| ToDo | Description | Progress |
|--|--|--|
 Simplified the spawning script | The enemy spawning script now uses a public vector 3 array when chosing the position of each enemy| 90%|
| Game testing & research |* |	100% |
...
| ToDo | Description | Progress |
|--|--|--|
| Research and testing for autogenerated map | Attempted to make a script that places rooms randomly on the background & generated paths between them |	30% |
| Revert autogenerated map to the map built manually | A script that generates the map would require to completely change the way we render tiles on our screen | 100% |
...
| ToDo | Description | Progress |
|--|--|--|
| Ui debugging| Base testing for game demo & debugging |	100% |
| Debug on the player character's colider | The colliders fail when our character is moving too fast toward an object | 100% |
| Game testing & research |* |	100% |
